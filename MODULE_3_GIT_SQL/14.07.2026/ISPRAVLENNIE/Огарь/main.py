...
async def seed_data():
    ...
    async with async_session_maker() as session:
        ...
        inst1.profile = InstructorProfile(bio="Senior Python Developer",
                                          experience_years=10)
        inst2 = Instructor(name='Мария Сидорова', email='m@school.com')
        inst2.profile = InstructorProfile(bio='Data Scientist',
                                          experience_years=5)

        # 2. Курсы
        course1 = Course(title='Python с нуля до профи', price=15000,
                         instructor=inst1)
        course2 = Course(title='Асинхронное программирование на Python',
                         price=25000, instructor=inst1)
        course3 = Course(title='Введение в Data Scientist', price=30000,
                         instructor=inst2)
        ...
        session.add_all([inst1, inst2, course1, course2, course3,
