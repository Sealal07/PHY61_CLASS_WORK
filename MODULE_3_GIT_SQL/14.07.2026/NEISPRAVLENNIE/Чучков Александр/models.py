...
class InstructorProfile(Base):
    ...
    instructor_id: Mapped[int] = mapped_column(ForeignKey('inctructors.id', ondelete='CASCADE'), unique=True)
...
class Course(Base):
    ...
    instructor_id: Mapped[int] = mapped_column(ForeignKey('inctructors.id', ondelete='SET NULL'), unique=True)
